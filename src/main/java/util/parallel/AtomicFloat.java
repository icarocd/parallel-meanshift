...
/**
 * A float value that may be updated atomically. An atomic float works like an atomic integer. (See
 * {@link java.util.concurrent.atomic.AtomicInteger}.) For example, an atomic float might be used for parallel computation of the
...
public class AtomicFloat extends Number implements java.io.Serializable {
     ...
     * @return true, if successfully set; false, if the current value was not equal to the expected value.
     */
